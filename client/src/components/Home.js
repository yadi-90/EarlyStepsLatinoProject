...
const Home = () => {
  ...
  return (
    <div>
      {location.pathname === '/' ? (
        <img class="mainimage" src=" https://images.unsplash.com/photo-1616543791139-fdca422b7ef7?auto=format&fit=crop&q=80&w=2787&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="family" />
      ) : null}
...
<img src = "https://www.cdc.gov/ncbddd/autism/addm-community-report/images/key-finding-demographics.png"> 
</img>
<h1>Our Mission</h1>
<p>
